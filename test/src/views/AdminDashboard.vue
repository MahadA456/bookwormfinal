...
export default {
  ...
  setup() {
    ...
    return {
      ...
      showAddBookModal,
      books,
      years: Array.from({ length: 2024 - 1900 + 1 }, (_, i) => 1900 + i), // Array of years from 1900 to 2024
      genres: ['Fiction', 'Non-fiction', 'Science Fiction', 'Fantasy', 'Mystery', 'Biography'], // Example genres
      createBook,
      editBook,
      updateBook,
      deleteBook,
